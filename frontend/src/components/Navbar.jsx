    ...
    <header className="bg-[#1C1C1E] border-b border-[#3A3A3C] px-4 py-3 shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-4">
          <a href="/questions" className="text-[#8E8E93] hover:text-white hover:bg-[#2C2C2E] px-3 py-2 rounded-md font-medium transition-all duration-200">
            Questions
          </a>
          <a href="/tags" className="text-[#8E8E93] hover:text-white hover:bg-[#2C2C2E] px-3 py-2 rounded-md font-medium transition-all duration-200">
            Tags
          </a>
          {isLoggedIn && (
            <a href="/ask" className="gradient-orange text-white px-4 py-2 rounded-md font-semibold shadow-sm hover:-translate-y-0.5 hover:shadow-md transition-all duration-200">
              Ask Question
            </a>
          )}
        </nav>
        ...
        <div className={`hidden md:flex items-center gap-3 relative`}>
          {isLoggedIn ? (
            ...
            <>
              <a href="/login" className="text-[#8E8E93] bg-transparent border border-[#3A3A3C] px-4 py-2 rounded-md font-medium transition-all duration-200 hover:text-white hover:border-[#FF6B35] hover:bg-[#2C2C2E] no-underline inline-block">
                Login
              </a>
              <a href="/register" className="gradient-orange text-white border-none px-5 py-2 rounded-md font-semibold transition-all duration-200 shadow-sm hover:-translate-y-0.5 hover:shadow-md no-underline inline-block">
                Sign Up
              </a>
            </>
          )}
      ...
      {showMobileMenu && (
        <div className="md:hidden bg-[#1C1C1E] border-t border-[#3A3A3C] px-4 py-4">
          ...
          <nav className="space-y-2">
            <a href="/questions" className="block text-[#8E8E93] hover:text-white hover:bg-[#2C2C2E] px-3 py-2 rounded-md font-medium transition-all duration-200">
              Questions
            </a>
            <a href="/tags" className="block text-[#8E8E93] hover:text-white hover:bg-[#2C2C2E] px-3 py-2 rounded-md font-medium transition-all duration-200">
              Tags
            </a>
            {isLoggedIn ? (
              <a href="/ask" className="block gradient-orange text-white px-4 py-2 rounded-md font-semibold shadow-sm transition-all duration-200">
                Ask Question
              </a>
            ) : (
              <>
                <a href="/login" className="block text-[#8E8E93] hover:text-white hover:bg-[#2C2C2E] px-3 py-2 rounded-md font-medium transition-all duration-200">
                  Login
                </a>
                <a href="/register" className="block gradient-orange text-white px-4 py-2 rounded-md font-semibold shadow-sm transition-all duration-200">
                  Sign Up
                </a>
              </>
            )}
